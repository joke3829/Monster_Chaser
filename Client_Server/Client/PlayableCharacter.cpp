...
void CPlayerMage::MakeBullet(float speed, int skill)
{
	...
	if (skill == 1) {
		...
		pos.y += 30.0f;
		projectile->setPosition(pos);
		projectile->setMoveDirection({ m_AutoDirect.x, -1.5f, m_AutoDirect.z });
