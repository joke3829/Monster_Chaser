...
void CRaytracingScene::SetUp()
{
	...
	m_pRaytracingPipeline->AddLibrarySubObject(L"");
	m_pRaytracingPipeline->AddHitGroupSubObject(L"RadianHitGroup", L"");
	m_pRaytracingPipeline->AddShaderConfigSubObject(10, 10);
...
void CRaytracingScene::CreateRootSignature()
{
	...
	}
	{
		...
		params[0].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space0
		params[0].Descriptor.RegisterSpace = 0;
		params[0].Descriptor.ShaderRegister = 1;

		params[1].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, spcae1
		params[1].Descriptor.RegisterSpace = 1;
		params[1].Descriptor.ShaderRegister = 1;

		params[2].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space2
		params[2].Descriptor.RegisterSpace = 2;
		params[2].Descriptor.ShaderRegister = 1;

		params[3].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space3
		params[3].Descriptor.RegisterSpace = 3;
		params[3].Descriptor.ShaderRegister = 1;

		params[4].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space4
		params[4].Descriptor.RegisterSpace = 4;
		params[4].Descriptor.ShaderRegister = 1;

		params[5].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space5
		params[5].Descriptor.RegisterSpace = 5;
		params[5].Descriptor.ShaderRegister = 1;

		params[6].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space6
		params[6].Descriptor.RegisterSpace = 6;
		params[6].Descriptor.ShaderRegister = 1;

		params[7].ParameterType = D3D12_ROOT_PARAMETER_TYPE_SRV;	// t1, space7
		params[7].Descriptor.RegisterSpace = 7;
