...
;
; shader hash: 585baad0f3e36cdcf62536891a89fcc1
;
; Buffer Definitions:
;
...
; <label>:182                                     ; preds = %165, %156
  ...
  %225 = call %dx.types.CBufRet.i32 @dx.op.cbufferLoadLegacy.i32(i32 59, %dx.types.Handle %11, i32 1)  ; CBufferLoadLegacy(handle,regIndex)
  %226 = extractvalue %dx.types.CBufRet.i32 %225, 2
  %227 = icmp eq i32 %226, 0
  br i1 %227, label %280, label %228

; <label>:228                                     ; preds = %182
  %229 = fmul fast float %219, 2.000000e+00
  %230 = fmul fast float %220, 2.000000e+00
  %231 = fmul fast float %221, 2.000000e+00
  %232 = fmul fast float %229, %222
  %233 = fmul fast float %230, %222
  %234 = fmul fast float %231, %222
  %235 = fadd fast float %232, 0xBFE279A740000000
  %236 = fadd fast float %233, 0xBFE279A740000000
  %237 = fadd fast float %234, 0xBFE279A740000000
  %238 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %12, i32 8)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %242 = call float @dx.op.worldRayOrigin.f32(i32 147, i8 0)  ; WorldRayOrigin(col)
  %243 = call float @dx.op.worldRayOrigin.f32(i32 147, i8 1)  ; WorldRayOrigin(col)
  %244 = call float @dx.op.worldRayOrigin.f32(i32 147, i8 2)  ; WorldRayOrigin(col)
  %245 = call float @dx.op.rayTCurrent.f32(i32 154)  ; RayTCurrent()
  %246 = call float @dx.op.worldRayDirection.f32(i32 148, i8 0)  ; WorldRayDirection(col)
  %247 = call float @dx.op.worldRayDirection.f32(i32 148, i8 1)  ; WorldRayDirection(col)
  %248 = call float @dx.op.worldRayDirection.f32(i32 148, i8 2)  ; WorldRayDirection(col)
  %249 = fmul fast float %246, %245
  %250 = fmul fast float %247, %245
  %251 = fmul fast float %248, %245
  %252 = fsub fast float %239, %242
  %253 = fsub fast float %252, %249
  %254 = fsub fast float %240, %243
  %255 = fsub fast float %254, %250
  %256 = fsub fast float %241, %244
  %257 = fsub fast float %256, %251
  %258 = call float @dx.op.dot3.f32(i32 55, float %253, float %255, float %257, float %253, float %255, float %257)  ; Dot3(ax,ay,az,bx,by,bz)
  ...
  %263 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %11, i32 7)  ; CBufferLoadLegacy(handle,regIndex)
  %264 = extractvalue %dx.types.CBufRet.f32 %263, 3
  %265 = call float @dx.op.dot3.f32(i32 55, float %235, float %236, float %237, float %260, float %261, float %262)  ; Dot3(ax,ay,az,bx,by,bz)
  ...
  %270 = fcmp fast ole float %223, 0.000000e+00
  %271 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %11, i32 6)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %275 = fmul fast float %269, 0x3FE99999A0000000
  %276 = select i1 %270, float 0.000000e+00, float %275
  %277 = fmul fast float %276, %272
  %278 = fmul fast float %276, %273
  %279 = fmul fast float %276, %274
  br label %280

; <label>:280                                     ; preds = %228, %182
  %281 = phi float [ %277, %228 ], [ 0.000000e+00, %182 ]
  %282 = phi float [ %278, %228 ], [ 0.000000e+00, %182 ]
  %283 = phi float [ %279, %228 ], [ 0.000000e+00, %182 ]
  %284 = fadd fast float %224, 0x3FD99999A0000000
  %285 = fmul fast float %284, %157
  %286 = fadd fast float %285, %281
  %287 = fmul fast float %284, %158
  %288 = fadd fast float %287, %282
  %289 = fmul fast float %284, %159
  %290 = fadd fast float %289, %283
  br i1 %183, label %291, label %295

; <label>:291                                     ; preds = %280
  %292 = fmul fast float %286, 5.000000e-01
  %293 = fmul fast float %288, 5.000000e-01
  %294 = fmul fast float %290, 5.000000e-01
  br label %295

; <label>:295                                     ; preds = %291, %280
  %296 = phi float [ %292, %291 ], [ %286, %280 ]
  %297 = phi float [ %293, %291 ], [ %288, %280 ]
  %298 = phi float [ %294, %291 ], [ %290, %280 ]
  %299 = insertelement <4 x float> undef, float %296, i32 0
  %300 = insertelement <4 x float> %299, float %297, i32 1
  %301 = insertelement <4 x float> %300, float %298, i32 2
  %302 = insertelement <4 x float> %301, float 1.000000e+00, i32 3
  %303 = getelementptr inbounds %struct.RadiancePayload, %struct.RadiancePayload* %payload, i32 0, i32 0
  store <4 x float> %302, <4 x float>* %303, align 4, !tbaa !47
  ret void
}
...
const unsigned char compiledShader[] = {
  0x44, 0x58, 0x42, 0x43, 0xbc, 0x3e, 0x41, 0x62, 0xef, 0x03, 0xc9, 0x6d,
  0xe4, 0xff, 0x9d, 0x1d, 0x51, 0x1c, 0x70, 0xca, 0x01, 0x00, 0x00, 0x00,
  0xe8, 0x45, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00,
  ...
  0x07, 0x94, 0xc2, 0x0c, 0x40, 0x51, 0x94, 0x45, 0x81, 0x0a, 0x94, 0x22,
  ...
  0x00, 0x00, 0x00, 0x00, 0x58, 0x5b, 0xaa, 0xd0, 0xf3, 0xe3, 0x6c, 0xdc,
  0xf6, 0x25, 0x36, 0x89, 0x1a, 0x89, 0xfc, 0xc1, 0x44, 0x58, 0x49, 0x4c,
  0x38, 0x25, 0x00, 0x00, 0x63, 0x00, 0x06, 0x00, 0x4e, 0x09, 0x00, 0x00,
  0x44, 0x58, 0x49, 0x4c, 0x03, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
  0x20, 0x25, 0x00, 0x00, 0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00,
  0x45, 0x09, 0x00, 0x00, 0x0b, 0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00,
  ...
  0x61, 0x20, 0x00, 0x00, 0x4d, 0x02, 0x00, 0x00, 0x13, 0x04, 0x54, 0x2c,
  0x10, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00, 0x04, 0x28, 0x4b, 0x81,
  ...
  ,
  ...
  0x0c, 0x71, 0x12, 0xac, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
