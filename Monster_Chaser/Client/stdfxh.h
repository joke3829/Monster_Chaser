...
;
; shader hash: 217a0d3bed2cb89897206bf7c263a164
;
; Buffer Definitions:
;
...
; <label>:375                                     ; preds = %298, %278
  ...
  %404 = fmul fast float %403, 0x3FE99999A0000000
...
; <label>:408                                     ; preds = %375
  ...
  %451 = call %dx.types.CBufRet.f32 @dx.op.cbufferLoadLegacy.f32(i32 59, %dx.types.Handle %14, i32 6)  ; CBufferLoadLegacy(handle,regIndex)
  ...
  %455 = fmul fast float %449, 0x3FE99999A0000000
  %456 = select i1 %450, float 0.000000e+00, float %455
  %457 = fmul fast float %456, %452
  %458 = fmul fast float %456, %453
  %459 = fmul fast float %456, %454
  br label %460

; <label>:460                                     ; preds = %408, %375
  %461 = phi float [ %457, %408 ], [ 0.000000e+00, %375 ]
  %462 = phi float [ %458, %408 ], [ 0.000000e+00, %375 ]
  %463 = phi float [ %459, %408 ], [ 0.000000e+00, %375 ]
  %464 = fadd fast float %404, 0x3FD99999A0000000
  %465 = fmul fast float %464, %253
  %466 = fadd fast float %465, %461
  %467 = fmul fast float %464, %254
  %468 = fadd fast float %467, %462
  %469 = fmul fast float %464, %255
  %470 = fadd fast float %469, %463
  br i1 %279, label %471, label %475

; <label>:471                                     ; preds = %460
  %472 = fmul fast float %466, 5.000000e-01
  %473 = fmul fast float %468, 5.000000e-01
  %474 = fmul fast float %470, 5.000000e-01
  br label %475

; <label>:475                                     ; preds = %471, %460
  %476 = phi float [ %472, %471 ], [ %466, %460 ]
  %477 = phi float [ %473, %471 ], [ %468, %460 ]
  %478 = phi float [ %474, %471 ], [ %470, %460 ]
  %479 = insertelement <4 x float> undef, float %476, i32 0
  %480 = insertelement <4 x float> %479, float %477, i32 1
  %481 = insertelement <4 x float> %480, float %478, i32 2
  %482 = insertelement <4 x float> %481, float 1.000000e+00, i32 3
  %483 = getelementptr inbounds %struct.RadiancePayload, %struct.RadiancePayload* %payload, i32 0, i32 0
  store <4 x float> %482, <4 x float>* %483, align 4, !tbaa !50
  ret void
}
...
const unsigned char compiledShader[] = {
  0x44, 0x58, 0x42, 0x43, 0x57, 0xcf, 0x91, 0xd3, 0x34, 0x8d, 0x78, 0xf0,
  0xd8, 0x84, 0xea, 0xbc, 0xbc, 0xc0, 0x0e, 0x03, 0x01, 0x00, 0x00, 0x00,
  0xac, 0x4f, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x